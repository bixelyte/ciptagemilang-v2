<div>
  ...
  <section class="relative px-6 py-24 lg:px-20">
    <div class="mx-auto max-w-[1440px] text-center">
      <h2 class="text-3xl lg:text-5xl font-black uppercase tracking-tighter text-white mb-6">{{ __('Ready to Work Together?') }}</h2>
      <p class="text-white/50 text-sm mb-12 max-w-lg mx-auto">
        {{ __('Let\'s discuss how we can bring your project vision to life with our expertise and dedication.') }}
      </p>
