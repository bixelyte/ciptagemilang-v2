<div>
    ...
    <div class="mx-auto max-w-[1440px]">
      <div class="mb-20 flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">
        <div class="max-w-2xl relative">
          <span class="mb-4 inline-block text-xs font-bold uppercase tracking-[0.4em] text-primary bg-background-dark/60 px-3 py-1.5 rounded-sm">What We Do</span>
          <h1 class="mt-4 text-5xl font-black uppercase tracking-tighter lg:text-7xl gold-gradient-text hero-glow-text text-glow-light inline-block">OUR SERVICES</h1>
        </div>
        <div class="relative">
  ...
  <section class="relative px-6 py-24 lg:px-20">
    <div class="mx-auto max-w-[1440px] text-center">
      <h2 class="text-3xl lg:text-5xl font-black uppercase tracking-tighter text-white mb-6">Need Our Services?</h2>
      <p class="text-white/50 text-sm mb-12 max-w-lg mx-auto">
        Get in touch with our team to discuss your project requirements and receive a tailored solution.
      </p>
